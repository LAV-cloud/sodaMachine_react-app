  ...
  const userDraw = () => {
    return (
      <div className={soda.count > 0 ? styles.soda__item : styles.soda__item_empty}>
        <img src={`http://localhost:5000/images/${soda.image}`} alt={soda.name} className={styles.soda__icon} />
    ...
    return (
      <div className={count > 0 ? styles.soda__item : styles.soda__item_empty}>
        <div className={adminStyles.soda__iconBlock}>
          ...
          <img src={file.value() ? file.value().img : `http://localhost:5000/images/${soda.image}`} alt={soda.name} className={adminStyles.soda__icon} />
        </div>
        <h4 className={styles.soda__title}>{soda.name}</h4>
